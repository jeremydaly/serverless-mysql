...
describe('SQL Query Logging Integration Tests', function () {
    // Increase timeout for integration tests
    this.timeout(15000);

    let db, dbWithoutLogging;
    const TEST_TABLE = 'log_sql_test_table';
    const TABLE_SCHEMA = `
  ...
  `;
    ...
    it('should log SQL with substituted parameters when returnFinalSqlQuery is enabled', async function () {
    ...
    it('should not log SQL when returnFinalSqlQuery is disabled', async function () {
    ...
    it('should log SQL with complex parameter types correctly', async function () {
    ...
    it('should log SQL with object parameters correctly', async function () {
